...
import store.StoreErokuApp;
import store.config.audit.AuditEventConverter;
import store.domain.PersistentAuditEvent;
import store.repository.PersistenceAuditEventRepository;
import store.service.AuditEventService;
...
@SpringBootTest(classes = StoreErokuApp.class)
@Transactional
